...
public class FaSongLieBiaoPage extends FluentPage {
	...
	//  FluentWebElement getWrappedElement()获得org.openqa.selenium.WebElement  这个是 原生的WebElement对象 和原来的操作一样
	// FluentWebElement是包装了WebElement的对象  增加了额外方法
	public String getTitle(){
		
		//$("#test").text(); == 
		//@FindBy(id = "test")
		//private FluentWebElement test;
		// test.text();
		//return getTitle.getWrappedElement().getText();//获得  <title>内容</title> “内容”
